...
public interface Plc2Mapper
{
     ...
     * 新增plc记录
     */
    @Insert("INSERT INTO plc2(id,acquisition_time,status,plc_type,sixty_feeding_request,sixty_cutting_request,sixty_on_position,sixty_feeding_done,sixty_cutting_done,sixty_forward,sixty_reverse,"+
    ...
    "op70_location_zs,okzs_code,okzs_code1,ngzh_code,op60_location_xn,op70_location_xn,marking_code,productionline_state,plan_number,plan_amount,production_number," +
    ...
    "#{seventyOnPosition},#{seventyFeedingDone},#{seventyCuttingDone},#{seventyForward},#{seventyReverse},#{OP60LocationZS},#{OP70LocationZS},#{OKZSCode},#{OKZSCode1},#{NGZHCode},"+
