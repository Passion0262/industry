...
//        将设备数据提取为TimeAnalysisByDate类数据
    ...
    static void device_data(Timestamp dateEnd, List<OP40Current> op40data, List<OP50Current> op50data, List<OP60Current> op60data, List<OP70Current> op70data, List<MeasuringMachine> measuringMachineData, List<plc1> plc1Data, List<plc2> plc2Data) {
        ...
        if (measuringMachineData.size()==0){
            ...
            measuringMachineTemp.setId(measuringMachineTemp.getId()+1);measuringMachineTemp.setAcquisitionTime(dateEnd);}
        measuringMachineData.add(measuringMachineTemp);

        plc1 plc1temp;
        if (plc1Data.size()==0){plc1temp = new plc1(1,dateEnd,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
        }else{plc1temp = plc1Data.get(plc1Data.size() - 1);plc1temp.setId(plc1temp.getId()+1);plc1temp.setAcquisitionTime(dateEnd);}
        plc1Data.add(plc1temp);

        plc2 plc2temp;
        if (plc2Data.size()==0){plc2temp = new plc2(1,dateEnd,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
        }else{plc2temp = plc2Data.get(plc2Data.size() - 1);plc2temp.setId(plc2temp.getId()+1);plc2temp.setAcquisitionTime(dateEnd);}
